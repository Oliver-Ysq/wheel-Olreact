...
var onStart = function onStart() {
  ...
  timer = setInterval(function () {
    ...
    Olreact.createElement("div", {
      className: "container"
    }, Olreact.createElement("h1", {
      namex: "title",
      style: styleObj
    }, "Number:", num), Olreact.createElement("button", {
      onClick: onStart
    }, " start "), Olreact.createElement("button", {
      onClick: onPause
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8498" + '/');
